...
- [Task 1.1 — Create users & groups](images/task1.1.png)
- [Task 1.2 — Set directory permissions](images/task1.2.png)
- [Task 2.1 — Check connectivity to google.com](images/task2.1.png)
...
- [Task 2.5 — DNS lookup](images/task2.5.png)
- [Task 2.6 — Download test file](images/task2.6.png)
- [Task 2.7 — Monitor bandwidth in real time](images/task2.7.png)
